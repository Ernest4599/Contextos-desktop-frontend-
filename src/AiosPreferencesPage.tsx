...
function AiosPreferencesPage() {
  ...
  return (
    <div className="flex-1 p-6 h-screen overflow-y-auto max-w-2xl mx-auto w-full">
      ...
      <h1 className="text-2xl font-bold text-white mb-1">AIOS Preferences</h1>
      <p className="text-slate-400 mb-8">Control how AIOS uses and applies your identity.</p>
        ...
        <>
          <div className="border border-slate-800 rounded-2xl p-6 mb-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-white font-semibold">Personalization Level</h2>
            </div>
              ...
              {LEVELS.map((l) => (
                <button
                  ...
                  className={`text-left border rounded-xl p-4 transition-colors ${
                    level === l.id ? 'border-blue-500 bg-blue-600/5' : 'border-slate-800 hover:border-slate-700'
                  }`}
                >
            ...
            <h3 className="text-white text-sm font-medium mb-3">Memory Categories AIOS Can Use</h3>
          ...
          <div className="border border-red-600/30 rounded-2xl p-6">
            <h2 className="text-white font-semibold mb-2">Reset AIOS Identity</h2>
            ...
            {resetDone && <p className="text-green-400 text-xs mb-3">AIOS identity reset.</p>}

            {!resetConfirm ? (
              <button
                type="button"
                onClick={() => setResetConfirm(true)}
                className="flex items-center gap-2 border border-red-600/40 text-red-400 text-sm font-medium px-4 py-2.5 rounded-lg hover:bg-red-600/10 transition-colors"
              >
                <RotateCcw size={16} />
                Reset AIOS Identity
              </button>
              ...
              <div className="flex items-center gap-3">
                <p className="text-red-400 text-sm">Are you sure? This can't be undone.</p>
                <button
                  type="button"
                  disabled={resetting}
                  onClick={handleReset}
