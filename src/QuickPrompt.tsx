    ...
    <div className="flex-1 flex flex-col gap-6 p-4 h-dvh overflow-y-auto md:gap-8 md:p-6 md:flex-row">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex flex-col gap-3 items-start justify-between mb-2 sm:flex-row sm:items-center">
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white md:text-3xl">Quick Prompt</h1>
          <button
            type="button"
        ...
        <div className="border border-slate-200 dark:border-slate-800 rounded-2xl p-4 md:p-6">
          ...
          <div className="mb-6">
            <h3 className="text-slate-900 dark:text-white font-semibold mb-1">Overview</h3>
            <p className="text-slate-600 dark:text-slate-400 text-sm mb-3">Explain the main situation or context.</p>
          ...
          <div className="mb-6">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-sm mb-3">What's already been decided or locked in?</p>
            <div className="relative">
              <textarea
                rows={4}
                maxLength={2000}
          ...
          <div className="mb-6">
            <h3 className="text-slate-900 dark:text-white font-semibold mb-1">Task</h3>
            <p className="text-slate-600 dark:text-slate-400 text-sm mb-3">What do you need help with right now?</p>
            <div className="relative">
              <textarea
                rows={4}
                maxLength={2000}
          ...
          <div className="flex items-center justify-center gap-2 mt-4 text-slate-600 dark:text-slate-400 text-sm text-center">
      ...
      <div className="w-full md:w-60 shrink-0 md:ml-auto flex flex-col gap-4">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4">
          <h3 className="text-slate-900 dark:text-white font-semibold mb-4">What you'll get</h3>
          <p className="text-slate-600 dark:text-slate-400 text-xs mb-4">ContextOS will build a complete prompt including everything you provide.</p>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-slate-800 dark:text-slate-200 text-sm font-medium">Your goal and situation</p>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-slate-800 dark:text-slate-200 text-sm font-medium">Important decisions</p>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-slate-800 dark:text-slate-200 text-sm font-medium">Your task</p>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-slate-800 dark:text-slate-200 text-sm font-medium">Relevant constraints</p>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-slate-800 dark:text-slate-200 text-sm font-medium">Ready-to-use prompt</p>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-slate-900 dark:text-white font-semibold">Privacy First</h3>
          </div>

          <div className="flex flex-col gap-2.5">
            <div className="flex items-center gap-2">
              <Check size={14} className="text-green-500 shrink-0" />
              <span className="text-slate-700 dark:text-slate-300 text-sm">Processed locally on your device</span>
            </div>
            <div className="flex items-center gap-2">
              <Check size={14} className="text-green-500 shrink-0" />
              <span className="text-slate-700 dark:text-slate-300 text-sm">Nothing stored on our servers</span>
            </div>
            <div className="flex items-center gap-2">
              <Check size={14} className="text-green-500 shrink-0" />
            ...
            <div className="flex items-center gap-2">
              <Check size={14} className="text-green-500 shrink-0" />
              <span className="text-slate-700 dark:text-slate-300 text-sm">100% private by design</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-slate-900 dark:text-white font-semibold">Tips for better prompts</h3>
          </div>
