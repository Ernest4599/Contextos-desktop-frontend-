      ...
      <section className="border-b border-slate-800/60">
        <div className="mx-auto flex max-w-[1440px] flex-col gap-[clamp(20px,3vw,48px)] px-[clamp(16px,4vw,96px)] py-[clamp(24px,4vw,64px)] lg:flex-row lg:items-start">
          ...
          <div className="w-full lg:w-[clamp(220px,26vw,380px)] lg:shrink-0">
            ...
            <p className="mt-[clamp(6px,0.9vw,16px)] text-[clamp(10px,1vw,15px)] leading-6 text-slate-400">
              We extract the signal from the noise and turn it into a portable Context Package.
            </p>

            <div className="mt-[clamp(10px,1.6vw,24px)] flex items-center gap-[clamp(4px,0.6vw,8px)] text-[clamp(10px,1.05vw,15px)] font-medium text-white">
          ...
          <div className="flex-1 rounded-2xl border border-slate-800 bg-[#0a0f18] p-[clamp(10px,1.6vw,24px)] shadow-2xl">
            <div className="mb-[clamp(8px,1.4vw,20px)] flex items-center justify-between">
              <div className="flex items-center gap-[clamp(4px,0.7vw,10px)]">
                ...
                <span className="text-[clamp(10px,1.15vw,16px)] font-semibold text-white">AI Product Launch</span>
            ...
            <div className="grid grid-cols-2 overflow-hidden rounded-xl border border-slate-800 sm:grid-cols-4">
              <PackageColumn
                title="PROJECT"
...
function FeatureChip({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <div className="flex flex-col items-center gap-[clamp(3px,0.5vw,8px)] rounded-xl border border-slate-800 bg-slate-950/50 px-[clamp(4px,0.8vw,12px)] py-[clamp(6px,1vw,14px)]">
      <div className="h-[clamp(11px,1.1vw,16px)] w-[clamp(11px,1.1vw,16px)] text-blue-400">{icon}</div>
      <span className="text-center text-[clamp(6px,0.65vw,10px)] leading-tight text-slate-400">{label}</span>
    </div>
  )
}
...
function PackageColumn({ title, items }: { title: string; items: string[] }) {
  return (
    <div className="min-h-[clamp(120px,15vw,235px)] border-b border-r border-slate-800 p-[clamp(6px,1vw,16px)] last:border-r-0 sm:border-b-0">
            ...
            <p
              ...
              className={
                item === 'GOAL' || item === 'NEXT STEP' || item === 'CONSTRAINTS'
                  ...
                  : 'text-[clamp(6px,0.6vw,10px)] leading-relaxed text-slate-400'
              }
            >
              {item}
            </p>
