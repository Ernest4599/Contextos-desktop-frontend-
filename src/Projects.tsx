    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-sm p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-white text-lg font-semibold">New Project</h2>
        ...
        <label className="text-white text-sm font-medium block mb-2">Project Name</label>
        <input
          type="text"
          value={name}
          ...
          autoFocus
          className="w-full bg-slate-950 border border-slate-700 text-white text-sm rounded-lg px-4 py-3 placeholder:text-slate-500 focus:outline-none focus:border-blue-500 mb-5"
        />
        ...
        <div className="flex gap-3">
          <button
            type="button"
            onClick={onClose}
            className="flex-1 border border-slate-700 text-slate-300 text-sm font-medium py-2.5 rounded-lg hover:bg-slate-800 transition-colors"
          >
            Cancel
          </button>
          <button
...
function Projects() {
  ...
  return (
    <div className="flex-1 p-6 h-screen overflow-y-auto">
      ...
      <p className="text-slate-400 mb-8">Your AI projects, saved securely to your account.</p>
        ...
        <div className="flex flex-col gap-4">
          {projects.map((project) => (
            ...
            >
              ...
              <button type="button" className="text-slate-500 hover:text-slate-300 p-1" onClick={(e) => e.stopPropagation()}>
